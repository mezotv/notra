...
Generated blog posts are available in the dashboard as Markdown. Review the draft, make any edits, then copy the Markdown to your blog platform or CMS.

Output publishing integrations such as Webflow and Framer are planned, but generated content is currently reviewed and published manually.
