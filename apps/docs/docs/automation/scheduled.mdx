...
<CardGroup cols={2}>
  <Card title="Changelog entry" icon="list-checks">
  ...
  <Card title="LinkedIn post" icon="briefcase-business">
    A professional update to share with your network. Saved as a draft.
  </Card>

  <Card title="Tweet" icon="message-circle">
...
<CardGroup cols={2}>
  <Card title="Weekly product updates" icon="calendar-days">
    A LinkedIn post every Monday summarizing the previous week.
  </Card>

  <Card title="Monthly changelogs" icon="file-text">
    A changelog roundup on the 1st of each month, auto-published.
  </Card>

  <Card title="Daily launch content" icon="coffee">
...
<Accordion>
  <AccordionItem title="Match frequency to activity">
  ...
  <AccordionItem title="Align lookback with frequency">
  ...
  <AccordionItem title="Review generated content">
...
<Accordion>
  <AccordionItem title="Schedule not running">
    **Check:**
  ...
  <AccordionItem title="Run skipped or no content">
    **Check:**
  ...
  <AccordionItem title="Content quality issues">
    **Check:**
...
<CardGroup cols={2}>
  <Card title="Event-based automation" icon="zap" href="/automation/event-based">
