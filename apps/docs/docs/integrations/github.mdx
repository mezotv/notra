...
The GitHub integration reads activity from your repositories so Notra can generate changelogs, blog posts, and social posts. Since August 2026 the primary way to connect is the **Notra GitHub App**. The older personal access token flow still works and is labelled **Legacy** in the dashboard.
...
From that access Notra reads commits on the branch you track, merged pull requests, and published releases.

<Callout type="warning">
  Notra never writes to your repositories. It does not open issues or pull requests, push commits, or change settings.
</Callout>
...
<Steps>
  <Step title="Open the GitHub page">
    In the dashboard sidebar, click **Integrations**, then the **GitHub** card. Click **Connect GitHub** (or press `C`).
  </Step>
...
<CardGroup cols={2}>
  <Card title="Set up automation" icon="wand-sparkles" href="/automation/overview">
