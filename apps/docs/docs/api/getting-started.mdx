...
<img
  ...
  class="doc-image-light"
/>
<img
  src="/images/api/api-keys-dark.webp"
  alt="API Keys in the Notra dashboard"
  class="doc-image-dark"
/>
...
<CardGroup cols={2}>
  ...
  <Card title="Event Triggers" icon="zap" href="/api-reference/event-triggers/list-event-triggers">
    Event-based generation fired by GitHub webhooks: list, create, get, update and delete triggers.
  </Card>
  <Card title="Chats" icon="message-square" href="/api-reference/chats/list-chats">
    Start a chat and stream the reply, continue an existing chat, list chats, or look a chat up by an external channel id.
  </Card>
  <Card title="Skills" icon="wand-sparkles" href="/api-reference/skills/list-skills">
  ...
  <Card title="Agent" icon="bot" href="/api-reference/agent/list-agent-sessions">
