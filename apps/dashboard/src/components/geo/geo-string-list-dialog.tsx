...
export function GeoStringListDialog({
  ...
  return (
    <ResponsiveDialog onOpenChange={onOpenChange} open={open}>
      <ResponsiveDialogContent>
        <GeoStringListDialogBody {...bodyProps} />
      </ResponsiveDialogContent>
    </ResponsiveDialog>
  );
}
...
// `values` on every open without a reset effect.
function GeoStringListDialogBody({
  title,
  description,
  columnLabel,
  addPlaceholder,
  ...
  onSave,
  footer,
}: Omit<GeoStringListDialogProps, "open" | "onOpenChange">) {
