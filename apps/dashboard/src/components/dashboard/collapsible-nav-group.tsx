  ...
  return (
    <Collapsible onOpenChange={setOpen} open={isIconMode ? true : open}>
      <SidebarGroup>
        ...
        />
        <CollapsibleContent className="duration-normal h-(--collapsible-panel-height) overflow-hidden transition-[height] ease-out data-[ending-style]:h-0 data-[starting-style]:h-0">
