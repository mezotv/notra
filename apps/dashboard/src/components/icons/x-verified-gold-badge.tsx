...
const XVerifiedGoldBadge = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} fill="none" viewBox="0 0 22 22">
    <title>Verified organization</title>
    <g>
      <linearGradient
        gradientUnits="userSpaceOnUse"
        id="x-verified-gold-a"
        x1="4.411"
        x2="18.083"
        y1="2.495"
        y2="21.508"
