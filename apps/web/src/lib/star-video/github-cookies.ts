export const GITHUB_CONNECTED_COOKIE = "sv_github_login";
export const GITHUB_TOKEN_COOKIE = "sv_github_token";
export const GITHUB_STATE_COOKIE = "sv_github_state";
export const GITHUB_TOKEN_COOKIE_PATH = "/api/star-video";
export const GITHUB_COOKIE_PATH = "/";
...
export const GITHUB_CONNECTION_REQUIRED_MESSAGE =
  "Connect your GitHub account to generate a video.";
