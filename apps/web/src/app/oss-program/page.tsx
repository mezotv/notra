...
import { SUPPORTED_LICENSES } from "@/schemas/oss-program";
import { DEFAULT_SOCIAL_IMAGE, TWITTER_HANDLE } from "@/utils/metadata";
import { SITE_URL } from "@/utils/urls";

const title = "OSS Program";
const description =
  "A pilot program for open source builders. Get Notra's Basic plan free in exchange for feedback — turn your shipped work into changelogs, launch posts, and marketing assets.";
...
const BENEFITS = [
  {
    label: "The Basic plan, free",
    detail:
      "Full access to the $20/mo Basic plan while you're in the program — no credit card.",
  },
  {
  ...
  },
  {
    ...
    detail: "Shape the roadmap with feedback — that's the whole trade.",
  },
] as const;

const ELIGIBILITY = [
  "Your project is publicly available on GitHub or GitLab.",
  "It's licensed under an OSI-approved open source license (listed below).",
  "You're building something genuinely useful that benefits from content and marketing.",
  "You're an owner or maintainer of the repository.",
  "The project shows active development and community engagement.",
] as const;
    ...
    <div className="flex w-full flex-col items-center justify-start overflow-hidden border-border/70 border-b pt-20 sm:pt-24 md:pt-28 lg:pt-32">
      <section className="flex w-full items-center justify-center px-6 py-12 md:px-24 md:py-16">
        <div className="flex w-full max-w-[640px] flex-col items-center gap-4">
          <p className="font-medium font-sans text-primary text-sm uppercase tracking-wider">
            Pilot program
          </p>
          ...
          <p className="text-pretty text-center font-normal font-sans text-base text-muted-foreground leading-7">
            We're piloting free access to Notra for open source builders doing
            cool work. Get the Basic plan at no cost in exchange for honest
            feedback — and let your shipped work do the marketing.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-8">
          <div className="flex flex-col gap-2">
            ...
            <p className="max-w-2xl font-normal font-sans text-muted-foreground text-sm leading-6">
              While the pilot runs, accepted projects use Notra free. The only
              ask is that you tell us what works and what doesn't.
            </p>
          </div>
      ...
      <section className="w-full border-border/70 border-t px-6 py-12 md:px-24 md:py-16">
        <div className="mx-auto grid w-full max-w-5xl gap-10 md:grid-cols-2">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="font-normal font-sans text-muted-foreground text-sm leading-6">
              Your project must use a recognized OSI-approved open source
              license:
            </p>
            ...
            <p className="font-normal font-sans text-muted-foreground text-sm leading-6">
              Projects with no license, or under source-available / non-compete
              licenses (such as BSL, SSPL, or the Commons Clause), are not
              considered open source and aren't eligible.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full border-border/70 border-t px-6 py-12 md:px-24 md:py-16">
        <div className="mx-auto flex w-full max-w-2xl flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            <p className="font-normal font-sans text-muted-foreground text-sm leading-6">
              Spots are limited while we pilot the program. Tell us about your
              project and we'll be in touch by email.
            </p>
          </div>
          <OssApplicationForm />
        </div>
