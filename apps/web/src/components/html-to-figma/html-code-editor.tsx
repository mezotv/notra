...
export default function HtmlCodeEditor({
  ...
  return (
    <div className="relative h-[60vh] max-h-[44rem] min-h-[24rem] w-full overflow-hidden rounded-2xl border border-[#1E1E1E14] bg-background transition-colors focus-within:border-foreground/30 dark:border-white/10">
