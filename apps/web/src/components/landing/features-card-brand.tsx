export function FeaturesCardBrand() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0">
      <div className="absolute top-28.5 left-9.5 isolate flex h-84 w-135.25 flex-col overflow-clip rounded-2xl border-t border-t-[#E5E5E5CC] border-r border-r-[#E5E5E5CC] border-b border-b-[#E5E5E566] border-l border-l-[#E5E5E5CC] bg-[#F5F5F5CC] [box-shadow:#0000000D_0rem_0.25rem_0.625rem]">
        ...
        <div className="grow basis-[0%] rounded-t-lg border-t border-t-[#E5E5E599] bg-white px-4 py-3">
          <div className="w-fit min-w-min">
            <div className="mb-4">
              <div className="mb-3 flex items-center gap-2">
                ...
                <div className="font-sans text-[#171717] text-[0.875rem] leading-[142.857%]">
                  Tone Profile
                </div>
              </div>
              <div className="mb-3 flex h-8 w-fit items-center justify-between gap-1.5 rounded-lg border border-[#E5E5E5] py-2 pr-2 pl-2.5">
                <div className="grow basis-[0%] content-center font-sans text-[#171717] text-[0.875rem] leading-[142.857%]">
                  Professional
                </div>
                <svg
            ...
            <div className="pt-4">
              <div>
                ...
                <div className="inline-flex h-8 w-full items-center overflow-clip rounded-lg border border-[#E5E5E5] bg-[#E5E5E580] px-2.5 py-1 opacity-50">
                  <div className="h-[1.03125rem] w-137 shrink-0 font-sans text-[#737373] text-sm/4.5">
          ...
          <div className="pt-4">
            <div>
              <div className="mb-2 content-center font-medium font-sans text-[#171717] text-[0.875rem] leading-[100%]">
                Custom Instructions
              </div>
              <div className="flex min-h-25 w-full resize-y overflow-clip rounded-lg border border-[#E5E5E5] px-2.5 py-2">
                <div className="h-10 w-137 shrink-0 font-sans text-[#737373] text-sm/5">
