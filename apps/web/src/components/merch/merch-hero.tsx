    ...
    <section className="relative w-full overflow-x-clip px-6 pt-6 antialiased [font-synthesis:none]">
      <div className="relative isolate rounded-3xl bg-[#C8B2EE40] dark:bg-[#2a2140]">
        <div className="pointer-events-none absolute inset-0 overflow-clip rounded-3xl">
          <HeroDither className="-top-1.25 -left-10.75 absolute h-[calc(100%+1.25rem)] min-h-[66.125rem] w-[calc(100%+21.5rem)] min-w-[100.8125rem] bg-[#00000000]" />
        </div>
        ...
        <div className="relative flex w-full flex-col items-center">
          <div className="flex flex-col items-center gap-8 px-6 pt-28 pb-2 sm:gap-10 sm:pt-24 lg:pt-[7.5rem]">
            ...
            <div className="flex flex-col items-center gap-5">
              ...
              <p className="max-w-[26rem] text-center font-sans text-[#1E1E1EA6] text-sm leading-5 tracking-[-0.005em] dark:text-white/60">
          ...
          <div className="relative mx-auto mt-4 h-[18rem] w-full max-w-[87rem] sm:h-[30rem] lg:h-[36rem] xl:h-[45rem]">
            <Image
              ...
              className="-translate-x-1/2 -rotate-6 -bottom-24 sm:-rotate-12 lg:-top-10 xl:-top-27.5 absolute left-1/2 z-10 w-[clamp(19rem,60vw,24rem)] drop-shadow-[0_1.5rem_2.5rem_#1E1E1E40] sm:top-5 sm:bottom-auto sm:w-[27.5rem] lg:w-[36rem] xl:w-[48.75rem]"
              height={1600}
              priority
