...
export function ImpersonationBanner({ email, name }: ImpersonationBannerProps) {
  ...
  return (
    <output className="flex min-h-10 shrink-0 items-center justify-center gap-3 border-amber-300 border-b bg-amber-50 px-4 py-1.5 text-amber-950 text-sm dark:border-amber-900 dark:bg-amber-950 dark:text-amber-100">
