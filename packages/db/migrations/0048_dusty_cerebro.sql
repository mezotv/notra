CREATE TYPE "public"."title_filter_match_type" AS ENUM('contains', 'regex');--> statement-breakpoint
CREATE TABLE "github_title_filters" (
	"id" text PRIMARY KEY NOT NULL,
	"repository_id" text NOT NULL,
	"match_type" "title_filter_match_type" NOT NULL,
...
CREATE UNIQUE INDEX "githubTitleFilters_repository_matchType_pattern_uidx" ON "github_title_filters" USING btree ("repository_id","match_type",lower("pattern"));--> statement-breakpoint
...
CREATE UNIQUE INDEX "linearTitleFilters_integration_matchType_pattern_uidx" ON "linear_title_filters" USING btree ("integration_id","match_type",lower("pattern"));