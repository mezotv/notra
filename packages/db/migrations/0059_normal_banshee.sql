...
ALTER TABLE "approval_workflow_steps" ADD CONSTRAINT "approval_workflow_steps_reviewer_role_id_organization_roles_id_fk" FOREIGN KEY ("reviewer_role_id") REFERENCES "public"."organization_roles"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "approval_workflows" ADD CONSTRAINT "approval_workflows_applies_to_role_id_organization_roles_id_fk" FOREIGN KEY ("applies_to_role_id") REFERENCES "public"."organization_roles"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "member_role_assignments" ADD CONSTRAINT "member_role_assignments_role_id_organization_roles_id_fk" FOREIGN KEY ("role_id") REFERENCES "public"."organization_roles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "approval_workflows_org_role_uidx" ON "approval_workflows" USING btree ("organization_id","applies_to_role_id") WHERE "approval_workflows"."applies_to_role_id" IS NOT NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "member_role_assignments_member_role_uidx" ON "member_role_assignments" USING btree ("member_id","role_id");--> statement-breakpoint
CREATE INDEX "member_role_assignments_roleId_idx" ON "member_role_assignments" USING btree ("role_id");--> statement-breakpoint
CREATE INDEX "organization_roles_organizationId_idx" ON "organization_roles" USING btree ("organization_id");--> statement-breakpoint
CREATE UNIQUE INDEX "organization_roles_org_name_uidx" ON "organization_roles" USING btree ("organization_id","name");--> statement-breakpoint
CREATE UNIQUE INDEX "organization_roles_org_system_key_uidx" ON "organization_roles" USING btree ("organization_id","system_key") WHERE "organization_roles"."system_key" IS NOT NULL;--> statement-breakpoint
