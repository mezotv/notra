...
export default defineTool({
  description:
    "Save up to 50 strong examples of the company's own writing as brand references in one replay-safe, deduplicated operation. Prefer complete tweets and concise owned-blog excerpts with canonical source URLs.",
