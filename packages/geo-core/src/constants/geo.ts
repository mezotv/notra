...
/**
 * Batch steps a project scan runs side by side. Multiplied by the batch size
 * this is the number of model calls in flight per project.
 */
export const GEO_SCAN_BATCH_CONCURRENCY = 6;
