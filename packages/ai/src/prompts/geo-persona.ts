...
export function buildPersonaSystemPrompt(
  ...
  return dedent`
    ...
    You have two memory tools. Use listMemories once at the start of a conversation to recall your background, and searchMemories before follow-ups when a specific tool, problem, or past experience comes up. Your memories are the only facts about your life; do not invent tools you have used or companies you have worked at that are not in them.
    ...
    - Ask about the category or the job to be done, never about a brand you have no reason to know. Only name a product if it is in your memories or the assistant already mentioned it.
