  ...
  "node_modules/.pnpm/yaml@2.8.2/node_modules/yaml/dist/doc/directives.js"(
    ...
    var Directives = class _Directives {
      constructor(yaml, tags) {
        this.docStart = null;
        this.docEnd = false;
        this.yaml = { ..._Directives.defaultYaml, ...yaml };
        this.tags = { ..._Directives.defaultTags, ...tags };
      }
      clone() {
      ...
      atDocument() {
        ...
        switch (this.yaml.version) {
          ...
          case "1.2":
            ...
            this.tags = { ..._Directives.defaultTags };
            break;
        }
        return res;
      }
...
${indent}`
    ...
    function stringifyString(item, ctx, onComment, onChompKeep) {
      ...
      if (
        ...
        /[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(ss.value)
      )
        type = Scalar.Scalar.QUOTE_DOUBLE;
...
var require_float = __commonJS({
  "node_modules/.pnpm/yaml@2.8.2/node_modules/yaml/dist/schema/core/float.js"(
    ...
    var floatExp = {
      ...
      resolve: (str) => Number.parseFloat(str),
      stringify(node) {
    ...
    var float = {
      ...
      test: /^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,
      resolve(str) {
        const node = new Scalar.Scalar(Number.parseFloat(str));
...
var require_int = __commonJS({
  "node_modules/.pnpm/yaml@2.8.2/node_modules/yaml/dist/schema/core/int.js"(
    ...
    var intResolve = (str, offset, radix, { intAsBigInt }) =>
      intAsBigInt ? BigInt(str) : Number.parseInt(str.substring(offset), radix);
    ...
    var jsonScalars = [
      ...
      },
      {
        ...
        resolve: (str, _onError, { intAsBigInt }) =>
          intAsBigInt ? BigInt(str) : Number.parseInt(str, 10),
        stringify: ({ value }) =>
...
var require_float2 = __commonJS({
  "node_modules/.pnpm/yaml@2.8.2/node_modules/yaml/dist/schema/yaml-1.1/float.js"(
    ...
    var floatExp = {
      ...
      resolve: (str) => Number.parseFloat(str.replace(/_/g, "")),
      stringify(node) {
        const num = Number(node.value);
        return isFinite(num)
          ? num.toExponential()
...
var require_set = __commonJS({
  "node_modules/.pnpm/yaml@2.8.2/node_modules/yaml/dist/schema/yaml-1.1/set.js"(
    ...
    var YAMLSet = class _YAMLSet extends YAMLMap.YAMLMap {
      ...
      static from(schema, iterable, ctx) {
        const { replacer } = ctx;
        const set2 = new _YAMLSet(schema);
        if (iterable && Symbol.iterator in Object(iterable))
...
var require_resolve_flow_scalar = __commonJS({
  "node_modules/.pnpm/yaml@2.8.2/node_modules/yaml/dist/compose/resolve-flow-scalar.js"(
    ...
    function parseCharCode(source, offset, length, onError) {
      ...
      const code = ok ? Number.parseInt(cc, 16) : Number.NaN;
      if (isNaN(code)) {
...
var require_compose_doc = __commonJS({
  "node_modules/.pnpm/yaml@2.8.2/node_modules/yaml/dist/compose/compose-doc.js"(
    ...
    function composeDoc(
      ...
      const opts = { _directives: directives, ...options };
...
${end.comment}`
      ...
      *end(forceDoc = false, endOffset = -1) {
        if (this.doc) {
          ...
          const opts = { _directives: this.directives, ...this.options };
          const doc = new Document.Document(void 0, opts);
...
var _dir =
  typeof __dirname !== "undefined"
    ? __dirname
    : (0, import_node_path.dirname)(new URL(import_meta.url).pathname);
var SPEC_PATH = (0, import_node_path.join)(
  _dir,
  "../widgets-open-api-spec.yaml"
);
var WIDGET_PREFIXES = {
...
function loadSpec(path) {
  return (0, import_yaml.parse)(
    (0, import_node_fs.readFileSync)(path ?? SPEC_PATH, "utf-8")
  );
}
...
${ep.description}`);
  if (
    ...
    for (const p of ep.parameters) {
      const param = p;
      lines.push(
        `- \`${param.name}\` (${param.in}): ${param.schema ? JSON.stringify(param.schema) : "unknown"}`
      );
    }
  }
  if (ep.requestBody) {
...
${group}:`);
  ...
  if (widgetIdx === -1 && pathIdx === -1) {
    console.error(
      "Usage: query-spec.ts --widget <name> | --path <path> | --list"
    );
